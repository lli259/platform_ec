...
class VariableCounter:
    ...
    def mark_comparison(self, var1, var2, comparison):
        ...
        if var1 and var2:  # Var1 and Var2 not None (indicates non-candidate comparison)
            ...
            if comparison == clingo.ast.ComparisonOperator.NotEqual:  
                ...
                if var1 in self.comparison_variables['notEqual'].keys():
                    self.comparison_variables['notEqual'][var1].append(var2)
                else:
                    self.comparison_variables['notEqual'][var1] = [var2]
                if var2 in self.comparison_variables['notEqual'].keys():
                ...
                if var1 in self.comparison_variables['greatThan'].keys():
                ...
                # Make lessThan dictionary entry of var1: [var2]
                if var2 in self.comparison_variables['greatThan'].keys():
    ...
    def mark_comparison_eq(self, var1, var2, comparison):
        ...
        if var1 and var2:  # Var1 and Var2 not None (indicates non-candidate comparison)
            ...
            if comparison == clingo.ast.ComparisonOperator.Equal:  
                # Make notEqual dictionary entry of var1: [var2] and var2: [var1]
                if var1 in self.comparison_variables_eq['equal'].keys():
                    self.comparison_variables_eq['equal'][var1].append(var2)
                else:
                    self.comparison_variables_eq['equal'][var1] = [var2]
                if var2 in self.comparison_variables_eq['equal'].keys():
    ...
    def longest_path_finder(self, comp_type, seen_set, current_var):
        ...
        if comp_type == 'greatThan':
            ...
            if current_var in comparison_variables[comp_type].keys():
        ...
        if current_var in  comparison_variables[comp_type].keys():  # error checking
